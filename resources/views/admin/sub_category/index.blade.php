        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            <div class="page-heading">
                <div class="page-heading-copy">
                    ...
                    <div>
                        <p class="eyebrow mb-1"> Sub Category</p>
            ...
            <section class="panel">
                <div class="panel-header">
                    <div>
                        <h2 class="h5 mb-1 section-title"><i class="bi bi-table" aria-hidden="true"></i><span>Sub_Category
                                Table</span></h2>
                    ...
                    <div class="heading-actions text-end">
                        <a class="btn btn-primary btn-sm" href="{{route('sub_category.create')}}"><i class="bi bi-person-plus" aria-hidden="true"></i>
                            Add Sub_Category</a>
                    </div>
                </div>
                    ...
                    <table class="table align-middle mb-0" id="ordersTable" data-searchable-table>
                        ...
                        <tbody>
                            @foreach ($sub_items as $sub_item)
                                ...
                                <tr>
                                    <td class="fw-semibold">{{ $sub_item->id }}</td>
                                    <td>{{ $sub_item->name }}</td>
                                    <form action="{{ route('sub_category.destroy', $sub_item->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
